...
<head>
  ...
  <title>The "Jujutsu Kaisen" prequel trailer gets pretty chaotic (of course)</title>
...
<!-- SHARE CONTENT -->
  ...
  <a role="button" tabindex="0" title="Facebook" class="at-share-btn at-svc-facebook" href="https://www.facebook.com/sharer/sharer.php?u=https://www.scoutmag.ph/70101/jujutsu-kaisen-0-prequel-trailer/?utm_campaign=sharedpost">
  ...
  <span class="at-icon-wrapper" style="background-color: rgb(255, 255, 255); line-height: 50px; height: 50px; width: 50px; border-radius: 0%;">
    ...
    <a role="button" tabindex="0" title="LinkedIn" class="at-share-btn at-svc-linkedin" href="https://www.linkedin.com/shareArticle?mini=true&url=https://www.scoutmag.ph/70101/jujutsu-kaisen-0-prequel-trailer/">
    ...
    <a role="button" tabindex="0" title="Reddit" class="at-share-btn at-svc-reddit" href="http://www.reddit.com/submit?url=https://www.scoutmag.ph/70101/jujutsu-kaisen-0-prequel-trailer/">
      ...
      <a role="button" tabindex="0" title="Telegram" class="at-share-btn at-svc-telegram" href="https://telegram.me/share/url?url=https://www.scoutmag.ph/70101/jujutsu-kaisen-0-prequel-trailer/">
                      ...
                      <h2><a href="#"><?php echo htmlspecialchars($a_t[0]['title']);?></a></h2>
                        <div class="post-meta">
                          <ul class="list-unstyled mb-0">
                            <li class="author">by:<a href="https://www.scoutmag.ph/70101/jujutsu-kaisen-0-prequel-trailer/">
                            <?php echo htmlspecialchars($f_t[0]['firstname']); echo('&nbsp');echo htmlspecialchars($l_t[0]['lastname']);?>
                            </a></li>
                            <li class="date">date:<a href="#">November 3, 2021</a></li>
                          </ul>
                        </div>
                        <br>
                        <p style="text-align: center;"><img src="Entertainment/ENTERTAINMENT1.jpg" class="img-responsive" alt="Jujutsu Kaisen" ></p>
                      </div>
                     
                    
                      <blockquote>"Jujutsu Kaisen" is set to return. And like most things nowadays, it comes in prequel form.</blockquote>
                      <p class="mb-30">Released on Toho Animation's YouTube channel, the trailer for "Jujutsu Kaisen 0" introduces viewers to the prequel's big bad Suguru Geto, an arrogant sorcerer with a vendetta against non-magical folks. 
                        The preview then cuts to several scenes featuring familiar faces and some fan favorites, including the masked Satoru Gojo and Maki Zenin. </p>
                      <p class="mb-30">While the OG manga and anime adaptation shed light on student Yuji Itadori, "Jujutsu Kaisen 0" follows a character named Yuta Okkotsu, whose childhood best friend Rika gets killed in a car accident, 
                        resulting in her cursed spirit following his trail. Of course, there's an explanation for that-he has abilities yet to be honed, not until he arrives in a school for jujutsu sorcerers.</p>
                      <p class="mb-30">The prequel is based on the manga originally titled "Tokyo Metropolitan Curse Technical School" created by Gege Akutami. The miniseries kickstarted the "JJK" verse by introducing characters and their world, 
                        which would later shape the main series that came soon after.</p>
                      <p class="mb-30">"Jujutsu Kaisen 0" will premiere in Japan on Dec. 24. There's no word yet on a worldwide release date, but for now, you can check out the trailer below. (Or peep this cool "JJK" streetwear line. Your call.)</p>
                      <p style="text-align: center;"><iframe width="560" height="315"  src="https://www.youtube.com/embed/h3YKB_XWcb4" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe></p>
                      <!-- <p class="mb-30"></p> -->
                    </div>
                  </div>
                </div>
